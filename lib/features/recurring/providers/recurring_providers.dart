...
final recurringRuleProvider =
    FutureProvider.autoDispose.family<RecurringRule?, String>((ref, ruleId) {
...
final dayMaterializationProvider =
    FutureProvider.autoDispose.family<int, DateTime>((ref, date) {
  final normalized = DateTime(date.year, date.month, date.day);
  return ref.watch(recurrenceServiceProvider).materializeForDate(normalized);
});
