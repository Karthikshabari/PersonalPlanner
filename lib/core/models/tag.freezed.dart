...
@override
String toString() {
  return 'Tag(id: $id, name: $name, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt)';
}
...
class _Tag implements Tag {
  const _Tag({required this.id, required this.name, required this.createdAt, required this.updatedAt, this.deletedAt});
