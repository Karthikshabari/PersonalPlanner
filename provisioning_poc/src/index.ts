...
function html(body: string, status = 200, cookies: string[] = []): Response {
  ...
  return new Response(
    `<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Personal Planner provisioning POC</title><body><main><h1>Personal Planner provisioning POC</h1>${body}</main></body></html>`,
    { status, headers },
  );
}
