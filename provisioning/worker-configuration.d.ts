/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8f367bf55408285fad93af8ddb6fa9c2)
// Runtime types generated with workerd@1.20260915.1 2026-09-16 nodejs_compat
interface __BaseEnv_Env {
	POC_PHASE: string;
	POC_ORGANIZATION_SLUG: string;
	POC_PROJECT_NAME: string;
	POC_PROJECT_REF: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "POC_PHASE" | "POC_ORGANIZATION_SLUG" | "POC_PROJECT_NAME" | "POC_PROJECT_REF" | "OAUTH_SESSION_KEY" | "SUPABASE_OAUTH_CLIENT_ID" | "SUPABASE_OAUTH_CLIENT_SECRET" | "SUPABASE_OAUTH_REDIRECT_URI">> {}
}
declare module "*.sql" {
	const value: string;
