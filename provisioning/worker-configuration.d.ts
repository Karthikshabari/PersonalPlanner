/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 600bbc77e67e889f4290d27896e218c1)
// Runtime types generated with workerd@1.20260915.1 2026-09-16 nodejs_compat
interface __BaseEnv_Env {
	POC_PHASE: "oauth";
	POC_ORGANIZATION_SLUG: "example-organization";
	POC_PROJECT_NAME: "personal-planner-example-project";
	POC_PROJECT_REF: "example-project-ref";
	SUPABASE_OAUTH_CLIENT_ID: "your-supabase-oauth-client-id";
	SUPABASE_OAUTH_REDIRECT_URI: "https://your-worker.example.workers.dev/oauth/callback";
	OAUTH_SESSION_KEY: string;
	SUPABASE_OAUTH_CLIENT_SECRET: string;
	PROVISIONING_TRANSACTION: DurableObjectNamespace<import("./src/index").ProvisioningTransaction>;
	MANAGEMENT_ACCOUNT_PROJECT: DurableObjectNamespace<import("./src/index").ManagementAccountProject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ProvisioningTransaction" | "ManagementAccountProject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "POC_PHASE" | "POC_ORGANIZATION_SLUG" | "POC_PROJECT_NAME" | "POC_PROJECT_REF" | "SUPABASE_OAUTH_CLIENT_ID" | "SUPABASE_OAUTH_REDIRECT_URI" | "OAUTH_SESSION_KEY" | "SUPABASE_OAUTH_CLIENT_SECRET">> {}
}
declare module "*.sql" {
	const value: string;
